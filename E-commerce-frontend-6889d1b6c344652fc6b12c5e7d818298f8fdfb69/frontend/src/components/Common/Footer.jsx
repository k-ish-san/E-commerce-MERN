...
const Footer = () => {
  return (
    <footer className="border-t py-12">
        ...
        <div>
          ...
          <form className="flex" action="">
            <input
             ...
             border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus-ring-gray-500 transition-all"
              required
            />
            <button
              type="submit"
              className="bg-black text-white px-6 py-3 text-sm round-r-md hover:bg-gray-800 transition-all"
            >
              Subscribe
            </button>
          </form>
      ...
      {/* Footer Bottom */}
      <div className="contaainer mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6"></div>
