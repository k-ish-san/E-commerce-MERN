...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="p-4">
        <h2 className="text-xl font-semibold mb-3 p-4 rounded bg-gray-500">Menu</h2>
        <nav className="space-y-4 ">
            <Link to="#" onClick={toggleNavDrawer} className="block p-3 bg-gray-200 rounded text-gray-600 hover:text-black">
            Men
            </Link>
            <Link to="#" onClick={toggleNavDrawer} className="block p-3 bg-gray-200 rounded text-gray-600 hover:text-black">
            Women
